...
int main(int argc, char **argv) {
    ...
    /* TODO (DONE): Think of a scenario that is not tested by the current test cases. Create one additional test case to test this scenario. */
    ...
    //scenario for considering space and other alphabets
    DNA_sequence dna_seq_3;
    strcpy(dna_seq_3.sequence, "ABCDABCDTT AAGH");
