...
map:
    ...
    # THINK: Why a0?    // Becasue to pass as an argument to the function and we are using 10 in square funtion. 
    ### YOUR CODE HERE ###
    lw a0, 0(s0)
    ...
    # Where can you assume the returned value is?   // return value is in a0
    ### YOUR CODE HERE ###
    sw a0, 0(s0)
